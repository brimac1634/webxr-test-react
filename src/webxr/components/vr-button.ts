class VRButton{
	...
	showEnterVR(button: HTMLButtonElement) {
        ...
        function onSessionStarted(session: XRSession) {
            ...
            self._renderer.xr.setSession( session );
        ...
        button.onmouseenter = function () {
            ...
            button.textContent = currentSession ? 'EXIT VR' : 'ENTER VR';
        ...
        button.onclick = function () {
            ...
            if (!currentSession && navigator.xr) {
    ...
    showWebXRNotFound(button: HTMLButtonElement) {
